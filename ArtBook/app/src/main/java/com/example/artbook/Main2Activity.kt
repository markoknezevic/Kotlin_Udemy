...
class Main2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(info.equals("new")) {
            val image=BitmapFactory.decodeResource(applicationContext.resources,R.drawable.img)
            ...
            val global=Global.Image
            val image=global.getImage()
    ...
    fun save(view: View){
        ...
        val artName = txtName.text.toString()
